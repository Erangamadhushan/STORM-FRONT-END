    ...
    return (
        <div>
            <div className="flex flex-col items-center justify-center min-h-[400px] bg-black px-4 py-10">
                ...
                <div ref={ref} className={`transition-all duration-700 ease-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"} text-white p-6 rounded-lg grid grid-cols-1 md:grid-cols-2 gap-8 w-full mt-10 `} id="brand-experience">
