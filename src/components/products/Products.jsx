            ...
            <div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                        <div>
                            <div>
                                <img src="product1.png" alt="digital-watch-type-1" className="size-52 object-cover mx-auto"/>
                            </div>
                            <div className="my-5">
                    ...
                    <div>
                        <div>
                            <div>
                                <img src="product2.png" alt="digital-watch-type-2" className="size-52 object-cover mx-auto"/>
                            </div>
                            <div className="my-5">
                    ...
                    <div>
                        <div>
                            <div>
                                <img src="product3.png" alt="digital-watch-type-3" className="size-52 object-cover mx-auto"/>
                            </div>
                            <div className="my-5">
