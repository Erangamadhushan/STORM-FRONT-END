...
export const PurchaseWatch = () => {
    ...
    const handleCheckout = (watch, quantity) => {
        console.log("Checkout:", { watch, quantity });
        updateOrder({ watch, quantity, totalPrice: watch.price * quantity, imageURL: watch.imageURL });
        navigate(`/check-out/${modelNumber}`);
    };
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                <button
                                onClick={() => handleCheckout(watch, quantity)}
